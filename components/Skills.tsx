...
// Map concepts to Lucide or Custom Icons
import { Shield, Code, Server, Lock, Globe, Box, Bug, Terminal as TerminalIcon, ShieldCheck, FileText, CheckSquare, Search, Eye } from 'lucide-react';

const SkillBadge = ({ icon: Icon, name, isCustom = false }: { icon: any, name: string, isCustom?: boolean }) => (
  <div className="group relative flex items-center justify-center p-3 bg-white dark:bg-[#121212] rounded-xl border border-gray-200 dark:border-white/10 hover:border-cyber-green transition-all duration-300 w-16 h-16 sm:w-20 sm:h-20 shadow-sm hover:shadow-[0_0_15px_rgba(0,255,157,0.2)]">
    ...
    <section id="skills" className="py-20 bg-white dark:bg-cyber-black transition-colors duration-300 scroll-mt-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 relative">
          <h2 className="text-5xl md:text-7xl font-black text-gray-200 dark:text-[#0f0f0f] uppercase tracking-tighter absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full select-none font-sans">
            Expertise
          </h2>
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start border-b border-gray-100 dark:border-white/5 pb-12">
            <div className="w-full md:w-64 flex-shrink-0">
              <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 font-mono">SIEM & SOC</h3>
              <p className="text-sm text-gray-500 dark:text-gray-500 mt-2 font-mono">Threat Detection & Response</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start border-b border-gray-100 dark:border-white/5 pb-12">
            <div className="w-full md:w-64 flex-shrink-0">
              <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 font-mono">Offensive Security</h3>
              <p className="text-sm text-gray-500 dark:text-gray-500 mt-2 font-mono">VAPT & Exploitation</p>
            </div>
            <div className="flex flex-wrap gap-4 flex-1">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start border-b border-gray-100 dark:border-white/5 pb-12">
            <div className="w-full md:w-64 flex-shrink-0">
              <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 font-mono">Governance</h3>
              <p className="text-sm text-gray-500 dark:text-gray-500 mt-2 font-mono">GRC & Standards</p>
            </div>
            <div className="flex flex-wrap gap-4 flex-1">
           ...
           <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="w-full md:w-64 flex-shrink-0">
              <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 font-mono">Automation</h3>
              <p className="text-sm text-gray-500 dark:text-gray-500 mt-2 font-mono">Scripting & DevOps</p>
            </div>
            <div className="flex flex-wrap gap-4 flex-1">
