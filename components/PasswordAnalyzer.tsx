...
const PasswordAnalyzer: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-24">
        ...
        <div className="bg-white dark:bg-[#111] border border-gray-200 dark:border-white/5 rounded-2xl p-8 shadow-xl dark:shadow-2xl flex flex-col md:flex-row gap-12">
