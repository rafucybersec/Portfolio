        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://linkedin.com/in/muhammadrafayali/" target="_blank" rel="noopener noreferrer" aria-label="Visit LinkedIn profile" className="w-10 h-10 border border-gray-300 dark:border-white/10 rounded-full flex items-center justify-center text-gray-700 dark:text-white hover:bg-cyber-blue-dark dark:hover:bg-cyber-blue hover:text-white dark:hover:text-black hover:border-cyber-blue-dark dark:hover:border-cyber-blue transition-all duration-300 hover:scale-110">
                <Linkedin size={18} />
              </a>
