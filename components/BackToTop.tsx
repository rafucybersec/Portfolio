...
const BackToTop: React.FC = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-10 right-10 z-50 p-4 text-cyber-green transition-all duration-700 ease-out group ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-12 scale-50 pointer-events-none'
        }`}
