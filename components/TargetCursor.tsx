...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  // Cyber-green themed cursor with neon glow
  const cornerColor = '#00ff9d';
  const cornerStyle = { willChange: 'transform' as const, borderColor: cornerColor };
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow: `0 0 6px ${cornerColor}, 0 0 12px ${cornerColor}40`
        }}
      />
      {/* Top-left corner */}
      <div
