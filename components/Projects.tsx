            ...
            <div className="p-6">
              ...
              <div className="flex gap-4 pt-4 border-t border-white/5">
                {project.links.github ? (
                  <a href={project.links.github} target="_blank" rel="noopener noreferrer" aria-label={`View source code for ${project.title}`} className="flex items-center gap-2 text-sm font-medium text-cyber-green hover:text-white transition-colors font-satoshi hover-glitch">
                ...
                {project.links.demo && (
                  <a href={project.links.demo} target="_blank" rel="noopener noreferrer" aria-label={`View live demo for ${project.title}`} className="flex items-center gap-2 text-sm font-medium text-cyber-green hover:text-white transition-colors font-satoshi hover-glitch">
