    ...
    <section id="about" className="py-20 scroll-mt-20 relative">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-transparent backdrop-blur-sm border border-white/10 rounded-2xl p-8 md:p-12 shadow-none relative overflow-hidden transition-all hover:border-cyber-green/50">
            {/* Decor */}
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6 relative z-10 font-light font-body">
              Hello! I'm <span className="text-cyber-green-dark dark:text-cyber-green text-sm md:text-base font-bold">Muhammad Rafay Ali</span>, a <span className="text-cyber-green-dark dark:text-cyber-green text-sm md:text-base font-bold">Cyber Security Engineer</span> with 2+ years of hands-on experience in SOC operations, SIEM engineering, threat detection, incident response, and security hardening. Deployed and tuned security platforms across multi-server enterprise environments, cutting undetected threat windows by 35% and false positive rates by 45%.
            </p>

            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6 relative z-10 font-light font-body">
              I specialize in <Activity size={18} className="inline mb-1 text-cyber-blue-dark dark:text-cyber-blue mx-1" /> <span className="text-cyber-green-dark dark:text-cyber-green text-sm md:text-base font-bold">SOC Operations</span>, <Database size={18} className="inline mb-1 text-purple-600 dark:text-purple-400 mx-1" /> <span className="text-cyber-green-dark dark:text-cyber-green text-sm md:text-base font-bold">SIEM Engineering</span>, and <Eye size={18} className="inline mb-1 text-red-600 dark:text-red-400 mx-1" /> <span className="text-cyber-green-dark dark:text-cyber-green text-sm md:text-base font-bold">Threat Detection & Response</span>, with expertise in ISO 27001, NCA-ECC, CIS Benchmarks, and MITRE ATT&CK frameworks.
            </p>

            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6 relative z-10 font-light font-body">
              Actively sharpening offensive and defensive skills through <span className="text-cyber-green-dark dark:text-cyber-green text-sm md:text-base font-bold">TryHackMe</span> and continuous lab-based research, translating attack techniques into practical detection and response strategies. Certified in <span className="text-cyber-green-dark dark:text-cyber-green text-sm md:text-base font-bold">ISO/IEC 27001 Lead Auditor, ISC2 CC, SOC Foundations, and Google Cybersecurity Professional</span> programs. Seeking to deliver managed security excellence in SOC/MSSP environments.
            </p>
