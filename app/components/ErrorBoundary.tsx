      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0a0a0a] p-4">
          <div className="max-w-md w-full bg-white dark:bg-cyber-gray/40 backdrop-blur-md rounded-xl border border-red-200 dark:border-red-900/50 p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 font-satoshi">
              Something went wrong
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6 font-satoshi text-sm">
            ...
            <button
              ...
              className="px-6 py-3 bg-cyber-green-dark dark:bg-cyber-green text-white dark:text-black font-bold rounded-lg hover:shadow-lg transition-all font-satoshi"
            >
              Reload Page
            </button>
          </div>
